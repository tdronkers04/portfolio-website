          ...
          <div className="md:flex">
            ...
            <div className="p-8">
              ...
              <p className="mt-2 text-gray-700">
                ...
                {' '}
                <a className="font-semibold text-[#011e6f] cursor-pointer" href="https://blog.dronkers.dev/buy-the-ticket-take-the-ride">calling</a>
                {' '}
                in full-stack software development.
                I’m a problem-solver by nature and do my best work in collaboration with others.
                I love exploring new technologies but feel most at home in the JavaScript ecosystem.
              </p>
            </div>
          </div>
        </div>
